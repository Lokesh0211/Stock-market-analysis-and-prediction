	...
	<header>
		...
		<nav>
			...
			<ul id="menu" style="width:1400px;margin-right:1000px;">
				<li ><a href="ArticleHome.jsp"><span><span>Home</span></span></a></li>
				...
				<li class="omega"  id="menu_active"><a href="PublishedArticles.jsp"><span><span>Published Articles</span></span></a></li>
